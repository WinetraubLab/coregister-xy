...
class TestParseXML(unittest.TestCase):
    ...
    #   test_project.M = np.array([[2,0,0], [0,1,0], [0,0,1]])
    ...
    #   s, theta = test_project.compute_physical_params_svd(test_project.M)
    #   self.assertAlmostEqual(s, 2)
    #   self.assertAlmostEqual(np.degrees(theta), 30)
